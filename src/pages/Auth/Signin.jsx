...
import logoImage from '../../assets/logoA. removebg-preview (1).png';
  ...
  return (
    <div className="min-h-screen  flex flex-col justify-center items-center px-2">
      <div className="w-full max-w-md">
        <form className="shadow-lg rounded px-8  pb-8 mb-4">
          <NavLink className="flex justify-center items-center" to="/">
            <img src={assets.NoByllLogoTransparent} alt="NoByll Logo" className="w-20 h-20 mb-8" />
          </NavLink>
