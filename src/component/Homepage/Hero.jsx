  ...
  return (
    <div className=" hero flex-row justify-between p-10 md:p-20 items-center lg:flex gap-8 ">
      ...
      <div className="md:w-3/5 h-fit  ">
        ...
        <h1 className="text-2xl sm:text-4xl font-bold mb-8">NoByll</h1>
      ...
      <div className="grid md:grid-cols-2 gap-8 w-100  lg:w-2/5 p-4 hero-right h-fit">
          ...
          <div className="card">
            <div className="   flex items-center jsutify-center w-full py-8 hero-card">
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="size-14 stroke-1 stroke-green-400 m-auto"
              >
                <path
                  strokeLinecap="round"
        ...
        <Link to={"/dashboard"} className="link">
          <div className="card">
            ...
            <p className="text-lg mb-2 font-extralight">Cables</p>
          </div>
        </Link>
      </div>
      {/* END OF HERO RIGHT */}
